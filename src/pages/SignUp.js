        ...
        <div className='inner-div d-flex justify-content-center align-items-center'>
            <div style={{height:'400px',width:'340px'}} className='mx-auto signUp-box px-5 py-4'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button className='w-100 py-2 mt-4 text-white'>Sign Up</button>
                </form>
                ...
                <p  style={{fontSize:'13px'}} className='text-secondary mt-3'>Already Subsicribe to Netflix? <Link to='/signin' style={{textDecoration:'none'}} className='text-white'> Sing In</Link></p>
            </div>
        </div>
    </div>
  )
